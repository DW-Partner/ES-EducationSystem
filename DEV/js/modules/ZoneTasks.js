	...
	$.jsonPage({
        ...
        eachDataHandle: function(msg,pageNum,pageSize){
			...
			if( msg.checked ){
        		...
        		msg.content = msg.content.replace( /填写当日流水/g, '<a href="javascript:;" data-href="/pss/goInAndOutCome?date=' + msg.time.split(' ')[0] + '&page=' + msg._page + '&msgid=' + msg.msg_id + '">填写当日流水</a>')
			}
