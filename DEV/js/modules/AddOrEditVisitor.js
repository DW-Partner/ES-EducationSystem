...
const form_tpl = '<li>\
            ...
            <li>\
                <span>来源</span>\
                <select name="origin" data-validate="any" placeholder="请输入来源">\
                    <option value="">请选择</option>\
            ...
            <li>\
                <span class="wide_2">关注与咨询方向</span>\
                <input type="text" class="long" value="{visitorContent}" placeholder="请输入关注与咨询方向(请用斜杠 / 隔开)" name="visitor_content" data-validate="any" />\
            </li>';
